 ...
 */
interface BulkVariationsCreatorInterface {
   ...
   *   // ...
   * ];
   * // @var \Drupal\commerce_bulk\BulkVariationsCreator $creator
   ...
   * @param array $not_all
   *   (optional) Additional settings to pass, such as the maximum number of
   *   variation combinations to create.
   *
   * @return \Drupal\commerce_product\Entity\ProductVariation
   ...
   *
   * @return array
   *   An array of all commerce product variations' combinations.
   */
